...
<h2>Link Manager</h2>
<div><?php /* Designed and developed by Gilbert Karogo K., a product of umatidocs.com */   echo "<a class='button-primary' href=".mvc_admin_url(array('controller' => 'admin_simplelender_links', 'action' => 'add',)).">New link</a>";	?>	</div>
<hr>
<table>
