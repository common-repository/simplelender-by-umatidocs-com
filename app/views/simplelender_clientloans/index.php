...
<div class="client_dash">
	...
	<div id="simplelender_dash_content">
			...
			<div></div>
		<center>
			<span class="fwidthtd"><b>Loan Applications</b></span>			
		</center>
		...
		<table id="simplelender_loan_dash">
			...
			<tr>
				...
				<td class="simplelender_sub_title"><center>Loan Name</center></td>
				<td class="simplelender_sub_title"><center>Stage</center></td>
